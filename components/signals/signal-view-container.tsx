              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <Badge
                      variant="outline"
                      className="text-[9px] uppercase tracking-widest font-bold border-border/60"
                    >
                      {signal.status}
                    </Badge>
                  </td>
                  ...
                  <td className="px-6 py-4 text-right">
                    {signal.result ? (
                      ...
                      <span className="text-[10px] uppercase font-bold text-muted-foreground/60 tracking-widest italic">
                        Live
                      </span>
                    )}
                  </td>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 p-6 rounded-lg border border-border bg-background hover:border-primary/40 transition-all hover:bg-muted/5">
                ...
                <div className="flex-1 w-full space-y-1">
                  <div className="flex items-center justify-between sm:justify-start sm:gap-4">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[10px] font-bold uppercase tracking-widest border-border/60"
                    >
                      {signal.status}
                    </Badge>
                  </div>
